...
<div class="container">
  ...
  <form class="form-connect" action="bin/connexion.php" method="post">
    <p><input name="mail" class="form-control" type="mail" id="mail" placeholder="Entrez votre Email" /></p>

    <p><input name="nom" class="form-control" type="text" id="nom" placeholder="Entrez votre Nom"/></p>

    <p><input name="prenom" class="form-control" type="text" id="prenom" placeholder="Entrez votre Prenom" /></p>

    <p><input name="age" class="form-control" type="text" id="age" placeholder="Entrez votre Age" /></p>
    ...
    <p><input class="form-control" type="password" name="password" id="password"  placeholder="Entrez votre Password" /></p>

    <p><input class="form-control" type="password" name="Cpassword" id="Cpassword" placeholder="Confirmez votre Password"/></p>
