...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 16 oct. 2018 à 11:19
...
INSERT INTO `driver` (`drv_id`, `drv_hiring_date`, `drv_licence_date`, `usr_id`, `drv_position`) VALUES
(1, '2018-09-02', '2017-09-02', 2, '{\"type\": \"Point\", \"coordinates\": [2.622933, 48.843222]}'),
(2, '2018-09-12', '2015-09-12', 1, '{\"type\": \"Point\", \"coordinates\": [2.624504, 48.844076]}');
...
--
ALTER TABLE `driver`
  MODIFY `drv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
